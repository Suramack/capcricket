...
part of 'bottom_nav_state_model.dart';
...
class _$BottomNavStateImpl implements _BottomNavState {
  const _$BottomNavStateImpl({this.bottomNavIndex = 0});
  ...
  @override
  String toString() {
    return 'BottomNavState(bottomNavIndex: $bottomNavIndex)';
  }
...
abstract class _BottomNavState implements BottomNavState {
  const factory _BottomNavState({final int bottomNavIndex}) =
